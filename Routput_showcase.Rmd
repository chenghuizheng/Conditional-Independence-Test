...
\begin{itemize}
    \item[(a)] \( Y_1 \sim X_1 + X_2 + X_3 + X_4+ \epsilon \), where \( X_i \) are mutually independent.
    \item[(b)] \( Y_2 \sim X_1 + X_2 + 0.001X_3 +X_4+ \epsilon \), where \( X_i \) are mutually independent.
    \item[(c)] \( Y_3 \sim X_1 + X_2 + X_3 + X_4+\epsilon \), where \( X_1 \not\perp\!\!\!\perp X_2 \).
    \item[(d)] \( Y_4 \sim X_1 + X_3 +X_4 \epsilon \), where \( X_1 \not\perp\!\!\!\perp X_2 \).
\end{itemize}
