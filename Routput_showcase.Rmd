...
```{r,echo=FALSE,warning=FALSE,message=FALSE}
loconew1 <- read.csv("r_output/simulation_locoallnew1.csv")
lococvnew1 <- read.csv("r_output/simulation_lococvnew1.csv")
lococv2 <- read.csv("r_output/simulation_lococv2.csv")
locoall2 <- read.csv("r_output/simulation_locoall2.csv")
lococv3 <- read.csv("r_output/simulation_lococv3.csv")
locoall3 <- read.csv("r_output/simulation_locoall3.csv")
lococv4 <- read.csv("r_output/simulation_lococv4.csv")
...
## LOCO only
```{r,echo=FALSE,warning=FALSE,message=FALSE}
loconew1$Features <- factor(loconew1$Features, levels = paste0("X", 1:20))
pl11 <- ggplot(loconew1, aes(x = Features, y = P.Value)) +
  ...
  labs(title = 'Case a): ',
       ...
       y = 'Averaged P.Value') +
  theme_minimal()
pl13 <- ggplot(loconew1, aes(x = Features, y = Feature_Importance_Score)) +
  geom_point(color = 'blue', size = 3) +
  geom_line(aes(group = 1), color = 'blue') +
...
lococvnew1$Features <- factor(lococvnew1$Features, levels = paste0("X", 1:20))
pl12 <- ggplot(lococvnew1, aes(x = Features, y = P.Value)) +
  geom_point(color = 'blue', size = 3) +
  geom_line(aes(group = 1), color = 'blue') +
  geom_hline(yintercept = 0.05, linetype = "dashed", color = "red")  +
  labs(title = 'Case a): ',
...
pl14 <- ggplot(lococvnew1, aes(x = Features, y = Feature_Importance_Score)) +
  geom_point(color = 'blue', size = 3) +
  geom_line(aes(group = 1), color = 'blue') +
  geom_hline(yintercept = 0, linetype = "dashed", color = "green")  +
  labs(title = 'Case a): ',
       ...
       y = 'Feature Importance Score') +
  theme_minimal()
plot_grid(pl11, pl12, labels = "AUTO")
plot_grid(pl13, pl14, labels = "AUTO")
```
...
pl21 <- ggplot(locoall2, aes(x = Features, y = P.Value, color = Correlation)) +
  geom_point(size = 3) +
  ...
  labs(title = 'Case b): ',
       ...
       y = 'Averaged P.Value') +
  theme_minimal()
pl23 <- ggplot(locoall2, aes(x = Features, y = Feature_Importance_Score,color = Correlation)) +
  geom_point(size = 3) +
  geom_line(aes(group = Correlation), size = 1) +
  scale_color_brewer(palette = "Set1")  +
  geom_hline(yintercept = 0, linetype = "dashed", color = "green")  +
...
pl22 <- ggplot(lococv2, aes(x = Features, y = P.Value,color = Correlation)) +
  geom_point(size = 3) +
  geom_line(aes(group = Correlation), size = 1) +
  scale_color_brewer(palette = "Set1") + 
  geom_hline(yintercept = 0.05, linetype = "dashed", color = "red")  +
...
pl24 <- ggplot(lococv2, aes(x = Features, y = Feature_Importance_Score,color =Correlation)) +
  geom_point( size = 3)+
  geom_line(aes(group = Correlation), size = 1) +
  scale_color_brewer(palette = "Set1") + 
  geom_hline(yintercept = 0, linetype = "dashed", color = "green")  +
  labs(title = 'Case b): ',
       ...
       y = 'Feature Importance Score') +
  theme_minimal()
plot_grid(pl21, pl22, labels = "AUTO")
plot_grid(pl23, pl24, labels = "AUTO")
...
pl31 <- ggplot(locoall3, aes(x = Features, y = P.Value, color = snr)) +
  geom_point(size = 3) +
  ...
  labs(title = 'Case c): ',
       ...
       y = 'Averaged P.Value') +
  theme_minimal()
pl33 <- ggplot(locoall3, aes(x = Features, y = Feature_Importance_Score,color = snr)) +
  geom_point(size = 3) +
  geom_line(aes(group = snr), size = 1) +
  scale_color_brewer(palette = "Set1")  +
  geom_hline(yintercept = 0, linetype = "dashed", color = "green")  +
...
lococv3$Features <- factor(lococv3$Features, levels = paste0("X", 1:20))
lococv3$snr <- as.factor(lococv3$snr)
pl32 <- ggplot(lococv3, aes(x = Features, y = P.Value,color = snr)) +
  geom_point(size = 3) +
  geom_line(aes(group = snr), size = 1) +
  scale_color_brewer(palette = "Set1") + 
  geom_hline(yintercept = 0.05, linetype = "dashed", color = "red")  +
...
pl34 <- ggplot(lococv3, aes(x = Features, y = Feature_Importance_Score,color =snr)) +
  geom_point( size = 3)+
  geom_line(aes(group = snr), size = 1) +
  scale_color_brewer(palette = "Set1") + 
  geom_hline(yintercept = 0, linetype = "dashed", color = "green")  +
  labs(title = 'Case c): ',
       ...
       y = 'Feature Importance Score') +
  theme_minimal()
plot_grid(pl31, pl32, labels = "AUTO")
plot_grid(pl33, pl34, labels = "AUTO")
```
...
pl41 <- ggplot(locoall4, aes(x = Features, y = P.Value)) +
  geom_point(color = 'blue', size = 3) +
  geom_line(aes(group = 1), color = 'blue') +
  geom_hline(yintercept = 0.05, linetype = "dashed", color = "red")  +
  labs(title = 'Case d): ',
       ...
       y = 'Averaged P.Value') +
  theme_minimal()
pl43 <- ggplot(locoall4, aes(x = Features, y = Feature_Importance_Score)) +
  geom_point(color = 'blue', size = 3) +
  geom_line(aes(group = 1), color = 'blue') +
  geom_hline(yintercept = 0, linetype = "dashed", color = "green")  +
  labs(title = 'Case d): ',
...
lococv4$Features <- factor(lococv4$Features, levels = paste0("X", 1:20))
pl42 <- ggplot(lococv4, aes(x = Features, y = P.Value)) +
  geom_point(color = 'blue', size = 3) +
  geom_line(aes(group = 1), color = 'blue') +
  geom_hline(yintercept = 0.05, linetype = "dashed", color = "red")  +
  labs(title = 'Case d): ',
...
pl44 <- ggplot(lococv4, aes(x = Features, y = Feature_Importance_Score)) +
  geom_point(color = 'blue', size = 3) +
  geom_line(aes(group = 1), color = 'blue') +
  geom_hline(yintercept = 0, linetype = "dashed", color = "green")  +
  labs(title = 'Case a): ',
       ...
       y = 'Feature Importance Score') +
  theme_minimal()
plot_grid(pl41, pl42, labels = "AUTO")
plot_grid(pl43, pl44, labels = "AUTO")
```
